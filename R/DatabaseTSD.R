...
#' @references Lubiana, A.l., Júnior, P.D.F., 2009. Pivotal temperature and sexual dimorphism of Podocnemis expansa hatchlings (Testudines: Podocnemididae) from Bananal Island, Brazil. Zoologia 26, 527-533.
